...
public class House {
	...
	public boolean equals(House h) {
		...
		// Your code here
		if (h.color == this.color && h.price == this.price && h.width == this.width && h.length == this.length &&
	...
	public double area() {
		...
		return (this.width * this.length); // replace this line with your own code
	}
	...
	public double volume() {
		...
		return (width * length * height); // replace this line with your own code
	}
