...
public class HousePersonMethodCheck {
	...
	public static void main (String[] args){
		...
		//double constructor
		try {
			house_parameterConstructor = House.class.getConstructor(new Class<?>[]{/*color*/House.Color.class, 
				/*price*/double.class, /*width*/double.class, /*length*/double.class, /*height*/double.class});
		} catch (Exception e) {}
		...
		//3 param constructor
		try {
			person_3parameterConstructor = Person.class.getConstructor(new Class<?>[]{/*name*/String.class, 
				/*age*/int.class, /*cash*/double.class});
		} catch (Exception e) {}
