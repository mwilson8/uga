...
implements VectorInterface
{
	...
	/**
	 * The number of valid components in this MyVector
	 */
	...
	/**
	 * Constructs an empty MyVector with the specified initial capacity 
	...
	/**
	 * Inserts the specified element at the specified position in this MyVector. 
	 * It should call the increaseCapacity method, if needed (if current size == current capacity)
	 * Shifts the element currently at position index (if any) and any subsequent 
	 ...
	 * It retains it's capacity (this method does not replace the inner array)
	 */
	public void clear(){
	...
	/* this method could be implemented if you wanted to continue development
	 * of the driver class
	 *
	/**
	 ...
	 * If capacity increment is DEFAULT_CAP_INC, the inner array should double in size, 
