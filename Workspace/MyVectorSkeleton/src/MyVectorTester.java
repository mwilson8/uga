...
public class MyVectorTester {
	...
	public static void main(String[] args) {
		...
		System.out.println("Read the comments below before executing this program");
		System.exit(0);
		
		////////if you chose to not have MyVector implement VectorInterface, then 
		...
		/*
		 * Tests of MyVector method implementations
		 */
