...
public class RandomWord {
	...
	enum WordBank {algorithms, ASCII, binary, branching, compile, CPU, debugging, 
	hardware, identifier, Java, JVM, logic, loops, memory, narrowing, 
	nesting, primitive, software, syntax, widening } 
