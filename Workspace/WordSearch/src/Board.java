 ...
 * @since 2018-03-27
 * 
 * A class to implement a word search board as the backbone of
 * WordsearchSolver - a lab for UGA 1301 students focusing on 
 * 2D arrays
 * 
 * You do not need to modify this file, but you may want to look
 * at the part of the code that shows the boards (starting around line 225)
 */
public class Board {
	...
	public void addSolution(String word, int startX, int startY, int endX, int endY){
		...
		studentSolution.sort(null); //sort into alphabetical order
	}
	 ...
	 */
	/*
	 * 		Everything below here is used for grading purposes; 
	 * 		you won't need methods after this part of the code
	 */
	/*
	 * 
	 * 
	...
	/**
	 * Constructor used for grading purposes. You can call this one if you'd like
	 * to pass in your own board and list of words. If you call this one you
	 * must use checkSolutions(String[]) to check 
	 */
	@Deprecated
	public Board(char[][] board, String[] list){
	...
	/**
	 * Method used for grading. Call this one if you used the Board constructor
	 * with your own board and list. 
	 * @param solution - the String[] containing the correct solution
	 * @param totalPoints - the total value of this test case
	 */
	@Deprecated
	public boolean checkSolutions(String[] solution, int totalPoints){
		Arrays.sort(solution); //sort alphabetical order
		double valuePerWord = totalPoints / solution.length;
		boolean passed = true;
		for (String s : solution){
			System.out.print("expected: \"" + s + "\"");
			if (studentSolution.contains(s))
				System.out.println("\t--> passed");
			
			else{
				System.out.println("\t--> not found -" + valuePerWord);
				passed = false;
			}
		}
		return passed;
	 ...
	 * this block runs before any constructor or method is called
	 * We could have put this code in the constructor or initialization, but it's
	 * down here to make the code more readable from the top
	 */
	static {
