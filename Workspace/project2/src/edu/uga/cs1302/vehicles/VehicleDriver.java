...
public class VehicleDriver {
	...
	public static void main(String[] args) {
		...
		vArray[6] = new Ship("USS Gerald R. Ford", "Newport News Shipbuilding", 2015, 4660, 35, 100000,
				"United States Navy");

		vArray[7] = new Ship("Harmony of the Seas", "STX France SA", 2015, 9080, 29, 226963, "Carnival Cruise Lines");

		vArray[8] = new Ship("Queen Mary 2", "STX Europe Chantiers de l'Atlantique", 2003, 3948, 35, 148528,
