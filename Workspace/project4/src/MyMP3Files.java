...
public class MyMP3Files {
	...
	public static void main (String[] args)
	{
	    ...
	    File mp3Dir = new File("/Users/MitchWilson/Desktop/Workspace/Project4/src/sample_music");
	    ...
	    for(File f: files){
	    	...
	    	if (error) System.out.println("There was a problem adding \"" + f.getName() + "\"");

	    }
	    
	    
	    //should the vector use an iterator or just it's elements?
